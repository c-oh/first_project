! function (e) {
    ...
    ! function (t, n) {
        ...
        re.fn = re.prototype = {
            ...
            isPlainObject: function (e) {
                return "object" === re.type(e) && !e.nodeType && !re.isWindow(e) && !(e.constructor && !Q.call(e.constructor.prototype, "isPrototypeOf"))
            },
                        ...
                        if (s) {
                            ...
                            ! function t(n) {
                                re.each(n, function (n, r) {
                                    var a = re.type(r);
                                    "function" === a ? e.unique && p.has(r) || s.push(r) : r && r.length && "string" !== a && t(r)
                                })
        ...
        re.event = {
            ...
            trigger: function (e, t, r, a) {
                ...
                if (i = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !Ie.test(f + re.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), u = f.indexOf(":") < 0 && "on" + f, e = e[re.expando] ? e : new re.Event(f, "object" == typeof e && e), e.isTrigger = a ? 2 : 3, e.namespace = h.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : re.makeArray(t, [e]), p = re.event.special[f] || {}, a || !p.trigger || p.trigger.apply(r, t) !== !1)) {
            ...
            style: function (e, t, n, r) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var a, o, i, s = re.camelCase(t),
                        l = e.style;
                    return t = re.cssProps[s] || (re.cssProps[s] = R(l, s)), i = re.cssHooks[t] || re.cssHooks[s], void 0 === n ? i && "get" in i && void 0 !== (a = i.get(e, !1, r)) ? a : l[t] : (o = typeof n, "string" === o && (a = Ke.exec(n)) && (n = (a[1] + 1) * a[2] + parseFloat(re.css(e, t)), o = "number"), void(null != n && n === n && ("number" !== o || re.cssNumber[s] || (n += "px"), ee.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), i && "set" in i && void 0 === (n = i.set(e, n, r)) || (l[t] = n))))
                }
            },
        ...
        re.fn.extend({
            val: function (e) {
                ...
                })) : a ? (t = re.valHooks[a.type] || re.valHooks[a.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(a, "value")) ? n : (n = a.value, "string" == typeof n ? n.replace(dt, "") : null == n ? "" : n)) : void 0
            }
        }), re.extend({
            valHooks: {
                option: {
        ...
        re.offset = {
            ...
            offset: function (e) {
                ...
                var t, n, r = this[0],
                    ...
                    o = r && r.ownerDocument;
                return o ? (t = o.documentElement, re.contains(t, r) ? (typeof r.getBoundingClientRect !== Se && (a = r.getBoundingClientRect()), n = G(o), {
    ...
    window.requestAnimationFrame = window.requestAnimationFrame || function (e) {
        ...
        var t = "tota11y-annotation-" + e,
            ...
            s = 20;
        return function e() {
            for (var t = 0; n.length > 0 && s > t; t++) {
                var r = n.shift();
                r.$parent.append(r.$annotation)
            }
